...
@Deprecated('Some devices has been crashing using this QrScannerScreen, this is most likely related to the native plugin used `qr_code_scanner`. Please use `barcode_scan` implementation for now.')
