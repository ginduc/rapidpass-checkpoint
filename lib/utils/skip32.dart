...
class Skip32 {
  static int g(Uint8List key, int k, int w) {
   ...
   * @param encrypt
   */
  static void skip32(Uint8List key, Uint8List buf, bool encrypt) {
    int k; /* round number */
    int i; /* round counter */
    int kstep;
    int wl, wr;
   ...
   */
  static int encrypt(int value, Uint8List key) {
   ...
   */
  static int decrypt(int value, Uint8List key) {
    final buf = Uint8List(4);
